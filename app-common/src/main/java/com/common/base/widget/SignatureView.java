...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.common.base.R.styleable.SignatureView);
        mPenColor = typedArray.getColor(com.common.base.R.styleable.SignatureView_penColor, PEN_COLOR);
        mBackColor = typedArray.getColor(com.common.base.R.styleable.SignatureView_backColor, BACK_COLOR);
        mPentWidth = typedArray.getInt(com.common.base.R.styleable.SignatureView_penWidth, PEN_WIDTH);
        typedArray.recycle();
        init();
    }
